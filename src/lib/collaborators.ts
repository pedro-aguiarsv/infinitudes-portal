...
export const FALLBACK_COLLABORATORS: Collaborator[] = [
  {
    ...
    bio: "Pedagoga, mestre em educação, escritora e palestrante. Professora universitária e consultora. Escreve para o blog Bendita Existência.",
    photo: null,
  ...
  },
  {
    ...
    bio: "Doutora em Finanças pela UFMG e contadora. Professora de Contabilidade e Gestão.",
    photo: null,
  ...
  },
  {
    ...
    bio: "Designer gráfica e de produto, doutoranda em estudos contemporâneos das artes e em formação em esquizoanálise.",
    photo: null,
  ...
  },
  {
    ...
    bio: "Socióloga e escritora, com atuação em estudos sobre estratificação social, mercado de trabalho, gênero, diversidade e violência contra a mulher.",
    photo: null,
